...
function HomePreparation() {
  const { t, i18n } = useTranslation();
  const isRTL = i18n.language === 'ar';
  const [lightboxSrc, setLightboxSrc] = useState(null);

  const features = [
    { icon: "🔌", title: t('homePrep.f1Title'), desc: t('homePrep.f1Desc') },
    { icon: "🎨", title: t('homePrep.f2Title'), desc: t('homePrep.f2Desc') },
    { icon: "🚪", title: t('homePrep.f3Title'), desc: t('homePrep.f3Desc') },
    { icon: "✅", title: t('homePrep.f4Title'), desc: t('homePrep.f4Desc') },
  ];
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            ...
            <div className="flex-1 z-10">
              <span className="badge">{t('homePrep.badge')}</span>
              <div className="accent-line mb-6" />
              <h1 className="text-5xl lg:text-6xl font-black text-gray-900 leading-tight mb-6">
                {t('homePrep.title1')}{" "}
                <span className="gold-text">{t('homePrep.titleHighlight')}</span>
                <br />
                {t('homePrep.title2')}
              </h1>
              ...
              <Link to="/quote" className="cta-btn">{t('homePrep.cta')}</Link>
            </div>
      ...
      <section className="bg-gray-50 py-20 px-6">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl font-bold text-gray-900">{t('homePrep.featuresTitle')}</h2>
            <p className="text-gray-500 mt-3">{t('homePrep.featuresSub')}</p>
          </div>
