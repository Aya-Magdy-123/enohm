...
function Construction() {
  ...
  const features = [
    { icon: "🏗️", title: t('construction.f1Title'), desc: t('construction.f1Desc') },
    { icon: "📐", title: t('construction.f2Title'), desc: t('construction.f2Desc') },
    { icon: "🏢", title: t('construction.f3Title'), desc: t('construction.f3Desc') },
    { icon: "⏱️", title: t('construction.f4Title'), desc: t('construction.f4Desc') },
  ];
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white" dir={isRTL ? "rtl" : "ltr"}>
      <style>{`
        ...
        .lightbox-close { position: absolute; top: 20px; right: 24px; color: white; font-size: 1.5rem; cursor: pointer; background: rgba(255,255,255,0.15); border: none; border-radius: 50%; width: 44px; height: 44px; display: flex; align-items: center; justify-content: center; transition: background 0.2s; }
        ...
        .cta-btn { background: linear-gradient(135deg, #eab308, #f59e0b); color: #fff; font-weight: 700; padding: 14px 36px; border-radius: 8px; border: none; cursor: pointer; font-size: 1rem; transition: all 0.3s ease; box-shadow: 0 8px 25px rgba(234,179,8,0.3); display: inline-block; }
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            ...
            <div className="flex-1 z-10">
              <span className="badge">{t('construction.badge')}</span>
              <div className="accent-line mb-6" />
              <h1 className="text-5xl lg:text-6xl font-black text-gray-900 leading-tight mb-6">
                {t('construction.title1')}{" "}
                <span className="gold-text">{t('construction.titleHighlight')}</span>
                <br />
                {t('construction.title2')}
              </h1>
              <p className="text-gray-600 text-lg leading-relaxed mb-8 max-w-lg">
                {t('construction.desc1')}
              </p>
              <p className="text-gray-500 text-base leading-relaxed mb-10 max-w-lg">
                {t('construction.desc2')}
              </p>
              <Link to="/quote" className="cta-btn">{t('construction.cta')}</Link>
            </div>
            ...
            <div className="flex-1 z-10">
              <div className="img-main overflow-hidden rounded-2xl mb-3 border-2 border-yellow-500/20">
                <img
                  src="https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=700&h=400&fit=crop"
                  alt="construction"
                  className="w-full h-64 object-cover zoomable"
                  onClick={() => setLightboxSrc("https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=1400&h=800&fit=crop")}
                />
              </div>
              <div className="grid grid-cols-3 gap-3">
                {[
                  "https://images.unsplash.com/photo-1541888946425-d81bb19240f5?w=300&h=200&fit=crop",
                  "https://images.pexels.com/photos/7108779/pexels-photo-7108779.jpeg",
                  "https://images.pexels.com/photos/15109998/pexels-photo-15109998.jpeg"
                ].map((src, i) => (
      ...
      <section className="bg-gray-50 py-20 px-6">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl font-bold text-gray-900">{t('construction.featuresTitle')}</h2>
            <p className="text-gray-500 mt-3">{t('construction.featuresSub')}</p>
          </div>
